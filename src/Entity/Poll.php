...
class Poll
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Comment::class, mappedBy: 'poll', orphanRemoval: true)]
    private Collection $comments;

    /**
     * @var Collection<int, Event>
     */
    #[ORM\OneToMany(targetEntity: Event::class, mappedBy: 'poll', orphanRemoval: true)]
    private Collection $events;

    /**
     * @var Collection<int, Participant>
     */
    #[ORM\OneToMany(targetEntity: Participant::class, mappedBy: 'poll', orphanRemoval: true)]
	#[OrderBy(['priority' => 'ASC'])]
